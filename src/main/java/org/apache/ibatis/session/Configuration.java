...
public class Configuration {
  ...
  protected final Map<String, Sdt> sdtMaps = new HashMap<String, Sdt>();
  ...
  public final void addSdt(Sdt sdt) {
	  sdtMaps.put(sdt.tbn(), sdt);
  }
  
  public final Sdt getSdt(String tb) {
	  return sdtMaps.get(tb);
  }
